...
public static class AnimMath
{
    ...
    public static Vector3 SpotOnCircleXZ(float radius, float currentAngle, float speed)
    {
        Vector3 offset = new Vector3();
        offset.x = Mathf.Sin(currentAngle * speed) * radius;
        offset.z = Mathf.Cos(currentAngle * speed) * radius;
        return offset;
    }
